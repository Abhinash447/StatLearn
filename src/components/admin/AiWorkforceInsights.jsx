  ...
  >
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-2 text-xs">
              <div className="flex items-center gap-2">
                <span className="font-bold text-slate-800">Impacted Divisions:</span>
                <span className="text-slate-600 font-mono">{ins.impactedDepartments.join(", ")}</span>
              </div>
              <div>
                <span className="font-bold text-blue-900 block mb-0.5">Recommended Policy Intervention:</span>
    ...
    /* Executive Report Render Zone if Generated */
      ...
      {reportData && <div className="bg-white rounded-2xl border-2 border-blue-600 p-6 sm:p-8 shadow-xl space-y-6 animate-in fade-in duration-300">
