...
export const QuizGenerator = () => {
  const { startQuizSession, showToast } = useApp();
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight mt-1">
              AI Quiz & MCQ Generator from Learning Materials
            </h1>
            <p className="text-slate-300 text-xs sm:text-sm mt-1 max-w-2xl leading-relaxed">
              Upload statistical training manuals, PDFs, survey guidelines, or policy circulars. 
              The AI automatically extracts key concepts and synthesizes calibrated MCQ quizzes with answer explanations.
            </p>
          </div>
  ...
  >
            ...
            <span>Try Demo Material (1-Click)</span>
          </button>
        </div>
      </div>
  ...
  />
              ...
              {uploadedFile || isUsingDemo ? <div className="space-y-2">
    ...
    /* Document Preview Snippet */
          ...
          {extractedText && <div className="bg-slate-50 rounded-xl p-3.5 border border-slate-200 text-xs">
  ...
  >
    ...
    /* Difficulty Level */
              ...
              <div>
                ...
                <div className="grid grid-cols-4 gap-2">
                  {["Easy", "Medium", "Hard", "Mixed"].map((diff) => <button
    key={diff}
    type="button"
  ...
  >
              ...
              <span>Generate AI Quiz & Start Assessment</span>
            </button>
