...
export const LearnerProfile = () => {
  const { user, updateProfile, competencies, overallCompetency, setActiveTab, t } = useApp();
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8 relative overflow-hidden">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-emerald-100 text-emerald-800 text-xs font-bold px-2.5 py-0.5 rounded-full flex items-center gap-1">
                  <CheckCircle2 className="w-3.5 h-3.5" /> {t("verifiedOfficial") || "Verified Official"}
                </span>
              </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span>{t("takeAssessmentBtn") || "Retake Diagnostic"}</span>
            </button>
          </div>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-slate-100 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          ...
          <div className="bg-slate-50 p-3 rounded-xl">
            <p className="text-[11px] text-slate-500">{t("kpiOverallCompetency") || "Overall Competency"}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">
                {t("fullNameLabel") || "Official Full Name"}
              </label>
              <input
                type="text"
                disabled={!isEditing}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">
                {t("emailLabel") || "Official Email Address (gov.in)"}
              </label>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">
                {t("designationLabel") || "Designation"}
              </label>
              <input
                type="text"
                disabled={!isEditing}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">
                {t("departmentLabel") || "Department / Division"}
              </label>
              <input
                type="text"
                disabled={!isEditing}
